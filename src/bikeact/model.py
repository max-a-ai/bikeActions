"""Vendored SkateFormer model (skeleton action recognition).

Adapted from the SkateFormer reference implementation (Do & Kim, ECCV 2024);
kept close to upstream for checkpoint compatibility. Not type-checked strictly.
"""
